...
const postApplication = catchAsyncErrors(async (req, res, next) => {
 ...
 const employerGetAllApplication = catchAsyncErrors(
    async (req, res, next) => {
      const { _id } = req.user;
  ...
  const jobSeekerGetAllApplication = catchAsyncErrors(
    async (req, res, next) => {
      const { _id } = req.user;
...
module.exports = { employerGetAllApplication, postApplication, jobSeekerGetAllApplication, deleteApplication }